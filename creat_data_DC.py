...
import torch
# from transformers import T5EncoderModel, T5Tokenizer, RobertaTokenizer, RobertaModel
...
def creat_data(datafile, cellfile):
    ...
    print('cell_features:', cell_features.shape)
    ...
    if ((not os.path.isfile(processed_data_file_train))):
        ...
        df = pd.read_csv('data/leave_drug/' + datasets + '.csv')
...
if __name__ == "__main__":
    ...
    # da = ['breast','colon','leave_breast','leave_colon','leave_lung','leave_melanoma',
    #       'leave_ovarian','leave_prostate','lung','melanoma','ovarian','prostate']

    da = ['d00','d11','d22','d33','d44','dd0and5','leave_d00','leave_d11','leave_d22','leave_d33','leave_d44','leave_dd0and5']
